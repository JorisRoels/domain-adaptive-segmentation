...
from networks.unet_bvae import UNetBetaVAE
...
parser.add_argument("--beta", help="Beta parameter value", type=float, default=1e-2)
...
net = UNetBetaVAE(feature_maps=args.fm, levels=args.levels, group_norm=(args.group_norm == 1), beta=args.beta)
