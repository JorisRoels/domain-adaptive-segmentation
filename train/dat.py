...
from networks.dat import UNet_DAT
...
net = UNet_DAT(n=args.input_size[0], lambdas=args.lambdas, feature_maps=args.fm, levels=args.levels, group_norm=(args.group_norm==1))
