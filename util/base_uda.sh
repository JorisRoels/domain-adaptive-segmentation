...
do
    ...
    do
        ...
        then
	        ...
	        python $PROJECT_DIR/util/build_config_da.py -b $PROJECT_DIR/train/unsupervised-da/config/base.yaml -ds ${DOMAINS_SRC[$i]} -dt ${DOMAINS_TAR[$j]} -m $METHOD -al $AVAILABLE_LABELS -c $COI -g 0
